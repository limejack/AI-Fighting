...
class Animation():
    def __init__(self, folder_paths, rate, size=(100,100)):
        ...
        for folder_path in folder_paths:
            ...
            self.rects[folder_path] = [[[i[0]/500*self.size[0],i[1]/500*self.size[1],i[2]/500*self.size[0],i[3]/500*self.size[1]] for i in j] for j in self.rects[folder_path]]
    ...
    def display(self, screen, pos, flip=False):
        ...
        for i in self.rects[self.current_animation][self.current_frame]:
            x,y,height,width = i
            pygame.draw.rect(screen,(0,255,0),(pos[0]+i[0],pos[1]+i[1],i[2],i[3]))
